    ...
    <section className="w-full h-dvh">
      <article className="w-4/5 h-dvh flex flex-col items-center justify-center gap-10 mx-auto">
        ...
        <p className="md:w-3/5 text-center text-sm">
          ...
          distinctio facere ipsum voluptatibus perferendis laboriosam labore
          minus neque incidunt, repudiandae dolor pariatur quae error
          dignissimos excepturi velit corporis corrupti dolorem?
        </p>
